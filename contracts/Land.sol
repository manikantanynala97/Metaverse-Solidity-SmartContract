...
contract Land is ERC721 {
    ...
    constructor(
        ...
        buildings.push(
            Building("Chicken Shop", address(0x0), 0, 0, 0, 10, 10, 10)
        );
        buildings.push(Building("Football Stadium", address(0x0), 0, 10, 0, 10, 5, 3));
        buildings.push(
            Building("Biryani Hotel", address(0x0), 0, -10, 0, 10, 5, 3)
        );
        buildings.push(
            Building("Shopping Mall", address(0x0), 10, 0, 0, 5, 25, 5)
        );
        buildings.push(
            Building("Web3 Community Hall", address(0x0), -10, 0, 0, 5, 25, 5)
        );
    }
